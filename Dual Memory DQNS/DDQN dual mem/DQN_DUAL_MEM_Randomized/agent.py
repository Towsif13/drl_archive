...
class Agent():
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        if self.mem_counter % 10 == 0 and len(self.memory2) > (BATCH_SIZE_2):
            ...
            pstate, paction, preward, pnext_state, pdone = self.memory2.pop(i)
            #print('\n','Reward', preward, 'RANDOM', i, ' len', len(self.memory2),'\n')
            ...
            #print('AVG {:.1f}'.format(avg_reward), 'Total {:.1f}'.format(self.total_reward))

            if (avg_reward > -250):
                # print('REW',preward)
                self.i += 1
                self.memory3.add(pstate, paction, preward, pnext_state, pdone)
                #print('\nMemory 3 Insertion', self.i, '\n')
        ...
        if (self.t_step % UPDATE_EVERY) == 0:
            ...
            if len(self.memory1) > BATCH_SIZE:
                ...
                # print('\nMemory 1 used for learing ',
                #       self.mem1_learn_counter, ' times\n')
        else:
            ...
            if len(self.memory3) > BATCH_SIZE_2:
                ...
                # print('\nMemory 3 used for learing ',
                #       self.mem3_learn_counter, ' times\n')
